...
def main(agent_weight_path, collaborative_weight_path, data_folder_path):
        ...
        if os.path.isdir(subfolder_path):
            for filename in os.listdir(subfolder_path):
                if filename.endswith('.jsonl'):
                    ...
                    update_scores(file_path, quality_weights, domain_weights, topic_weights, collaborative_weights, iteration=1)

if __name__ == "__main__":
    agent_weight_path = '/path/to/file'
    collaborative_weight_path = '/path/to/file'
    data_folder_path = '/path/to/folder'
    main(agent_weight_path, collaborative_weight_path, data_folder_path)
