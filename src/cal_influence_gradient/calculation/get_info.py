...
from less.data_selection.collect_grad_reps import (collect_grads, collect_grads_train, collect_reps,
                                                   get_loss)
...
parser.add_argument(
    "--info_type", choices=["grads", "reps", "loss","grads_train"], help="The type of information")
...
parser.add_argument("--slices", type=int, default=0, help = "The n-th slice of the dataset")
...
if args.task is not None:
    ...
    dataset = get_training_dataset(
        args.train_file, tokenizer, args.max_length, sample_percentage=1.0, slc = args.slices)
...
if args.info_type == "reps":
    ...
    collect_grads(dataloader,
                  ...
                  max_samples=args.max_samples)
elif args.info_type == "grads_train":
    collect_grads_train(dataloader,
                  model,
                  args.output_path,
                  proj_dim=args.gradient_projection_dimension,
                  gradient_type=args.gradient_type,
